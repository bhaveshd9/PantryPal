...
export function RecipeEditForm({ recipe, pantryItems, onSave }: RecipeEditFormProps) {
  ...
  // Cost calculation functions (same as recipe form)
  ...
  const getTotalRecipeCost = () => {
    return editedRecipe.ingredients.reduce((total, ingredient) => {
  ...
  const costPerServing = editedRecipe.servings > 0 ? totalCost / editedRecipe.servings : 0;
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => setEditedRecipe({ ...editedRecipe, cookTime: parseInt(e.target.value) || 0 })}
            required
          />
        </div>
      </div>
